...
\caption*{Figure~\thefigure~ Relationships Between Spaces, Openings and Their Corresponding Building Elements}
...
\centering
\caption{选定的IFC类别}
\caption*{Table~\thetable~ Selected IFC Categories} 
...
\caption*{Figure~\thefigure~ MGNM Edges: (a) Door to Corridor (b) Room to Door (c) Room to Window (d) Corridor to Window (e) Staircase (f) Corridor} 
...
\caption*{Figure~\thefigure~ IFC to MGNM Conversion Workflow Diagram: (a) BIM/IFC Model (b) Space Occupancy Area (c) Opening Elements (d) Corridor Occupancy Area (e) Space Nodes (f) Centroid of Opening Elements (g) Corridor Centerline (h) MGNM} 
